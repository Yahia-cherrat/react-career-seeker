...
const existingJobs: Job[] = jobsData.jobs as Job[]

// Determine the maximum existing ID
const getNextJobId = () => {
...
type AddJobPageProps = {
    addFormSubmit: (job: Job) => void
}

const AddJobPage = ({addFormSubmit} : AddJobPageProps) => {
